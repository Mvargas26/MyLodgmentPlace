 ...
 <body>
  ...
  <header id="header" class="d-flex align-items-center ">
    <div class="container-fluid d-flex align-items-center justify-content-lg-between">
      ...
      <!-- <img width="45" height="100" src="https://img.icons8.com/sf-black-filled/64/home.png" alt="home" /> -->
      <i class="bi bi-house-door-fill" style="font-size: 1.5em; color:#f4572c;"></i>
      </a></h1>
